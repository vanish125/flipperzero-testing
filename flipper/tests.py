...
class tests:
    ...
    def ikey_read_save_and_emu_dall(self):
        keeb_text = FlipperTextKeyboard(self, "key")
        self.main()
        self.send('loader open "iButton"')
        sleep(2)
        ...
        self.key('SHORT RIGHT')
        self.key('SHORT OK')
        keeb_text.send("Dallas")
        sleep(2) 
        self.key('SHORT DOWN')
        self.key('SHORT OK')
        
    def ikey_read_save_and_emu_cyf(self):
        keeb_text = FlipperTextKeyboard(self, "key")
        self.main()
        self.send('loader open "iButton"')
        sleep(2)
        ...
        self.key('SHORT RIGHT')
        self.key('SHORT OK')
        keeb_text.send("Cyfral")
        sleep(2) 
        self.key('SHORT DOWN')
        self.key('SHORT OK')

    def ikey_read_save_and_emu_met(self):
        keeb_text = FlipperTextKeyboard(self, "key")
        self.main()
        self.send('loader open "iButton"')
        sleep(2)
